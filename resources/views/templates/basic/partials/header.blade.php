                        ...
                        <div class="main_menu">
                            <nav id="mobile-nav">
                                <ul class="menu_list_box">
                                    ...
                                    @if($page->slug != 'home'  && $page->slug != 'pricing' && $page->slug != 'blog' && $page->slug != 'news' && $page->slug != 'plan' &&
                                    $page->slug != 'contact' && $page->slug != 'listing')
                                    ...
                                    @guest
                                    <li><a href="{{route('user.login')}}" class='{{ Route::is(' user.login') ? 'active'
                                            : '' }} theme_btn'><span class="btn_title"> <i
                                                    class="fa-regular fa-user"></i> @lang('Login') </span></a></li>
                                    @endguest
