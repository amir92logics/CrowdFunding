                ...
                <div class="card-body">
                    <div class="payment-method-item block-item">
                        ...
                        @if($gateway->code < 1000 && $gateway->extra)
                            ...
                            @endif
                            <div class="payment-method-body mt-2">
                                <h4 class="mb-3">@lang('Gateway Settings for') {{ __($gateway->name) }}</h4>
                                <div class="row">
                            ...
                            <div class="content w-100 ps-0">
                                <div class="d-flex justify-content-between">
                                    <div class="form-group">
                                        <h4 class="mb-3">{{ __($gateway->name) }} - {{__($gatewayCurrency->currency)}}
                                        </h4>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                    <div class="card border mt-2">
                                        <h5 class="card-header">@lang('Transaction Limit')</h5>
                                        <div class="card-body">
                                            <div class="form-group">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                    <div class="card border mt-2">
                                        <h5 class="card-header">@lang('Currency Setup')</h5>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
